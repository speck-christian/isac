...
from isac.selectors import TemporalSoftClusterSelector


def test_temporal_soft_cluster_selector_predicts_episode_actions() -> None:
    selector = TemporalSoftClusterSelector(
        n_configs=2,
